...
function HeaderAuthorized({isBurgerOpen, openBurger}){
    return(
        <div className="headerAuthorized">
            ...
            <div className={`header__burger ${isBurgerOpen ? 'header__burger_opened' : ''}`} onClick={openBurger} >
            <nav className={`header__menu ${isBurgerOpen ? 'header__menu_opened' : ''}`}>
                ...
                <div className={`header__account ${isBurgerOpen ? 'header__account_opened' : ''}`}>
                    <NavLink to="/profile" className="header__name">Аккаунт</NavLink>
                    <img src={accountImage} alt="Account" className="header__image"/>
                </div>
            </nav>
